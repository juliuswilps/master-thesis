...
def describe_graph_cot(graph: str, num_sentences=3, **kwargs):
    ...
    messages = [
        ...
        {
            "role": "user",
            "content": "Great, now please study the graph carefully and highlight any regions you may find surprising or counterintuitive. "
                       "Explain why they are surprising and what might have caused them.",
        },
